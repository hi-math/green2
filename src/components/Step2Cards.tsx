...
const CARDS: Step2Card[] = [
  {
    ...
    items: [
      ...
      { id: "daily-04", label: "학교 내 전기제품 대기전력 차단관리" },
      { id: "daily-05", label: "디벗 충전·관리 기준 수립 및 실천" },
      { id: "daily-06", label: "공간별·시설별 조명, 냉난방 관리 규칙 수립 및 실천" },
      { id: "daily-07", label: "교육공동체 일회용품 사용 줄이기 실천" },
      { id: "daily-08", label: "가정통신문 앱 활용, 종이없는 회의 실천" },
      { id: "daily-09", label: "쓰레기 분리배출 규칙 준수" },
    ],
  },
  {
    title: "실천 문화 확산",
    items: [
      ...
      { id: "culture-05", label: "학부모 및 지역 연계 실천 프로그램 운영" },
      { id: "culture-06", label: "음식물 쓰레기 줄이기 실천 프로그램 운영" },
      { id: "culture-07", label: "채식 급식의 날 정기적으로 운영" },
      { id: "culture-08", label: "급식 식자재 지역 농산물 적극 활용" },
      { id: "culture-09", label: "교복 물려주기 상시 운영" },
      { id: "culture-10", label: "학생 주도 나눔 장터 운영" },
    ],
  },
  {
    title: "학교 환경 조성",
    items: [
      { id: "env-01", label: "탄소 문해력 교육 게시판 또는 안내공간 조성" },
      {
        ...
        tooltip: "창문 단열 필름, 에코쿨루프 등",
      },
      { id: "env-05", label: "학교 숲·텃밭을 활용한 생물다양성 및 탄소중립 교육 프로그램 운영" },
      { id: "env-07", label: "학교 텃밭 운영 및 조경수용 빗물 저금통 설치 및 활용" },
